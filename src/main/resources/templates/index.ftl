...
<head>
    ...
    <meta charset="utf-8"/>
    <title>管理系统</title>
    <link rel="stylesheet" type="text/css" href="lib/extjs/themes/neptune/ext-theme-neptune-all.css"/>
    ...
    <script src="lib/extjs/ext-theme-neptune.js" type="text/javascript"></script>
