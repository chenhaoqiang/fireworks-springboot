Ext.define('Hzsun.ux.DatetimePicker', {
    extend: 'Ext.picker.Date',
    xtype: 'hzsundatetimepicker',
    requires: [
        'Ext.picker.Date',
        'Ext.slider.Single',
        'Ext.form.field.Time',
            ...
            items: [
                {
                    ...
                    width: '100%',
                    items:[ me.hourSlider,{html:':',padding:'1 5 5 5',}, me.minuteSlider,{html:':',padding:'1 5 5 5',},me.secondSlider],
                },
            ],
