 ...
 */  
Ext.define('Hzsun.ux.DatetimeField', {
    extend: 'Hzsun.form.field.Date',
    xtype: 'hzsundatetimefield',
    requires: ['Hzsun.ux.DatetimePicker'],
    ...
    createPicker: function() {
        ...
        var picker =  new Hzsun.ux.DatetimePicker({
            pickerField: me,
            floating: true,
            hidden: true,
